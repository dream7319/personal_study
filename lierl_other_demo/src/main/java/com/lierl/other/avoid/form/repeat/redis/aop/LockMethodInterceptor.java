package com.lierl.other.avoid.form.repeat.redis.aop;

import com.lierl.other.avoid.form.repeat.redis.annotation.CacheLock;
...
public class LockMethodInterceptor {
	...
	@Around("execution(public * *(..))&&@annotation(com.lierl.other.avoid.form.repeat.redis.annotation.CacheLock)")
